...
public final class WalletServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.aldren.server.wallet.grpc.WalletRequest,
      com.aldren.server.wallet.grpc.Empty> getDepositMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "deposit",
      requestType = com.aldren.server.wallet.grpc.WalletRequest.class,
      responseType = com.aldren.server.wallet.grpc.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.aldren.server.wallet.grpc.WalletRequest,
      com.aldren.server.wallet.grpc.Empty> getDepositMethod() {
    io.grpc.MethodDescriptor<com.aldren.server.wallet.grpc.WalletRequest, com.aldren.server.wallet.grpc.Empty> getDepositMethod;
      ...
      synchronized (WalletServiceGrpc.class) {
        if ((getDepositMethod = WalletServiceGrpc.getDepositMethod) == null) {
          WalletServiceGrpc.getDepositMethod = getDepositMethod =
              io.grpc.MethodDescriptor.<com.aldren.server.wallet.grpc.WalletRequest, com.aldren.server.wallet.grpc.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "deposit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aldren.server.wallet.grpc.WalletRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.aldren.server.wallet.grpc.WalletRequest,
      com.aldren.server.wallet.grpc.Empty> getWithdrawMethod;
  ...
  public static io.grpc.MethodDescriptor<com.aldren.server.wallet.grpc.WalletRequest,
      com.aldren.server.wallet.grpc.Empty> getWithdrawMethod() {
    io.grpc.MethodDescriptor<com.aldren.server.wallet.grpc.WalletRequest, com.aldren.server.wallet.grpc.Empty> getWithdrawMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.aldren.server.wallet.grpc.User,
      com.aldren.server.wallet.grpc.Transactions> getCheckTransactionsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "checkTransactions",
      requestType = com.aldren.server.wallet.grpc.User.class,
      responseType = com.aldren.server.wallet.grpc.Transactions.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.aldren.server.wallet.grpc.User,
      com.aldren.server.wallet.grpc.Transactions> getCheckTransactionsMethod() {
    io.grpc.MethodDescriptor<com.aldren.server.wallet.grpc.User, com.aldren.server.wallet.grpc.Transactions> getCheckTransactionsMethod;
      ...
      synchronized (WalletServiceGrpc.class) {
        if ((getCheckTransactionsMethod = WalletServiceGrpc.getCheckTransactionsMethod) == null) {
          WalletServiceGrpc.getCheckTransactionsMethod = getCheckTransactionsMethod =
              io.grpc.MethodDescriptor.<com.aldren.server.wallet.grpc.User, com.aldren.server.wallet.grpc.Transactions>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aldren.server.wallet.grpc.User.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aldren.server.wallet.grpc.Transactions.getDefaultInstance()))
  ...
  public static abstract class WalletServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void deposit(com.aldren.server.wallet.grpc.WalletRequest request,
    ...
    /**
     */
    public void withdraw(com.aldren.server.wallet.grpc.WalletRequest request,
        io.grpc.stub.StreamObserver<com.aldren.server.wallet.grpc.Empty> responseObserver) {
    ...
    /**
     */
    public void checkTransactions(com.aldren.server.wallet.grpc.User request,
        io.grpc.stub.StreamObserver<com.aldren.server.wallet.grpc.Transactions> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.aldren.server.wallet.grpc.WalletRequest,
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.aldren.server.wallet.grpc.User,
                com.aldren.server.wallet.grpc.Transactions>(
  ...
  public static final class WalletServiceBlockingStub extends io.grpc.stub.AbstractStub<WalletServiceBlockingStub> {
    ...
    /**
     */
    public com.aldren.server.wallet.grpc.Empty deposit(com.aldren.server.wallet.grpc.WalletRequest request) {
    ...
    /**
     */
    public com.aldren.server.wallet.grpc.Empty withdraw(com.aldren.server.wallet.grpc.WalletRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.aldren.server.wallet.grpc.Transactions checkTransactions(com.aldren.server.wallet.grpc.User request) {
      return blockingUnaryCall(
  ...
  public static final class WalletServiceFutureStub extends io.grpc.stub.AbstractStub<WalletServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.aldren.server.wallet.grpc.Empty> deposit(
        com.aldren.server.wallet.grpc.WalletRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.aldren.server.wallet.grpc.Empty> withdraw(
        com.aldren.server.wallet.grpc.WalletRequest request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.aldren.server.wallet.grpc.Transactions> checkTransactions(
        com.aldren.server.wallet.grpc.User request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DEPOSIT:
          serviceImpl.deposit((com.aldren.server.wallet.grpc.WalletRequest) request,
              (io.grpc.stub.StreamObserver<com.aldren.server.wallet.grpc.Empty>) responseObserver);
          break;
        case METHODID_WITHDRAW:
          serviceImpl.withdraw((com.aldren.server.wallet.grpc.WalletRequest) request,
              (io.grpc.stub.StreamObserver<com.aldren.server.wallet.grpc.Empty>) responseObserver);
          break;
        ...
        case METHODID_CHECK_TRANSACTIONS:
          serviceImpl.checkTransactions((com.aldren.server.wallet.grpc.User) request,
              (io.grpc.stub.StreamObserver<com.aldren.server.wallet.grpc.Transactions>) responseObserver);
          break;
        default:
